...
%   score      = confidence for recording class (higher => more likely recording)
    ...
    % ===== Dataset roots =====
    dataset_root   = 'D:\dataset\RIRplay';
    ...
    rec_files  = list_all_flucs_recursive(recording_root); 
    ...
    for i = 1:n_total
        ...
        try
            [pred_label, score, ratio] = my_original_recording_classifier(wav_path,threshold);
