...
new_folder = "RIRplay_with_SW";   % changing name for other handling
output_root = "D:\dataset\Our_Handle_dataset\" + new_folder + "\";
source_root = "D:\dataset\RIRplay\";   % recording
...
wav_file = dir(fullfile(source_root, '**', '*.wav'));
flac_file = dir(fullfile(source_root, '**', '*.flac'));
all_source_files = [wav_file;flac_file];
